...
export type PermitData = { number: string; city: string; project: string; address: string; fetchedAt: string; sourceUrl: string; notice?: string; inspections: Inspection[] };
export const jurisdictions: Record<string, number> = { Auburn:24, Bellevue:1, Burien:11, 'Clyde Hill':0, Medina:0, Redmond:0, Edmonds:23, 'Federal Way':25, Issaquah:3, Kenmore:4, 'King County':20, Kirkland:5, 'Mercer Island':6, Sammamish:7, Snoqualmie:9 };
